...
@WebServlet("/StudentListForExamController")
public class StudentListForExamController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			request.setAttribute("topic",ExamDAO.getTopicFromExamId(exam_id));
			request.getRequestDispatcher("studentListForSelectedExam.jsp").forward(request, response);
