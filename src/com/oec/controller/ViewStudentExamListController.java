...
@WebServlet("/ViewStudentExamListController")
public class ViewStudentExamListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			request.getRequestDispatcher("examListForStudentListView.jsp").forward(request, response);
