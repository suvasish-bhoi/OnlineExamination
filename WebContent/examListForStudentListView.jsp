...
<table cellpadding="0" cellspacing="0" border="0">
  <thead>
	...
	<%List<ExamVO> examList = (List<ExamVO>)request.getAttribute("examVoList");
	if(examList.isEmpty()){
		%>No Data To Display<%
	}else{ %>
	</div>
<div  class="tbl-content" style="width: 1070px;position: relative;bottom:50px;left: 35px;">
<table cellpadding="0" cellspacing="0" border="0">
  <tbody>
	<%
	int i=0;
	for(ExamVO eVo: examList){
		...
		<tr>
			...
			<td><%=eVo.getDescription() %>
			<td><a href="StudentListForExamController?exam_id=<%=eVo.getExam_id() %>" style="color: black;">Student List</a></td>
		</tr>
	<%
	}
	%>
