...
<center>
<form action="UploadQuestionAnswerController" method="post" enctype="multipart/form-data">
<input type="hidden" name="exam_id" value="<%=request.getParameter("exam_id")%>">
<input type="file" name="file" size="20" style="height: 40px;width:150px;border-radius:10px;"><br>
<input type="submit" value="Upload" style="color: black;border-radius:10px;height: 30px;width: 100px">
</form></center>
            <div class="row">
                <div class="col-lg-12">
