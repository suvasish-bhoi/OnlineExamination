  ...
  <tbody>
	...
	for(ExamVO eVo: examList){
		...
		<tr>
			...
			<td><a href="uploadQuestionAnswer.jsp?exam_id=<%=eVo.getExam_id()%>" style="color: black">Upload</a></td>
			<td><a href="DeleteExamController?exam_id=<%=eVo.getExam_id()%>"><input type="button" value="Delete"></a></td>
		</tr>
	<%
	}
	%>
